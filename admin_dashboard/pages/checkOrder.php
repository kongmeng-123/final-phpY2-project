...
$filterStatus = isset($_GET['status']) ? $_GET['status'] : 'Success';
try {
    $stmt = $pdo->prepare("
                ...
                <div class="container-fluid">
                    ...
                    <div class="shadow mb-4 card">
                        <div class="card-header py-3">
                            <a href="checkOrder.php?status=Success" class="btn <?php echo $filterStatus === 'Success' ? 'btn-success' : 'btn-primary'; ?> text-white">Success</a>
                            <a href="checkOrder.php?status=Shipping" class="btn <?php echo $filterStatus === 'Shipping' ? 'btn-info' : 'btn-primary'; ?> text-white">Transferring</a>
                            <a href="checkOrder.php?status=Cancelled" class="btn <?php echo $filterStatus === 'Cancelled' ? 'btn-danger' : 'btn-primary'; ?> text-white">Order fail</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table cellspacing="0" class="table table-bordered" id="dataTable" width="100%">
                                    ...
                                    <tbody>
                                        <?php if (empty($orders)): ?>
                                            <tr>
                                                <td colspan="7" class="text-center">No orders found for this status</td>
                                            </tr>
                                        <?php else: ?>
