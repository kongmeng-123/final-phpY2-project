    ...
    <script>
        ...
        function renderTable(dataToDisplay) {
            ...
            dataToDisplay.forEach(item => {
                ...
                let date_order = new Date(item.date_order);
                let end_date = new Date(item.end_date);

                function handleColor(date){
                    
                    if(date_order > dateNow) return "blue";
                    if((date_order < dateNow) && (end_date > dateNow)) return "green";
                    return "red"

                }
                function handleStatus(date){
                    if(date_order > dateNow) return "Inactive";
                    if((date_order < dateNow) && (end_date > dateNow)) return "Active";
                    return "Expired"
                }
