(function (h) {
    ...
    function Ga (a, b) {
        var c = l.defaults.column,
            ...
            c = h.extend({}, l.models.oColumn, c, {
                ...
                sTitle:
                    c.sTitle ? c.sTitle : b ? b.innerHTML : "",
        ...
        for (i = c.length; f < i; f++) {
            ...
            for (e = d.firstChild; e; ) {
                if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                    ...
                    n = g;
                    k = 1 === m ? !0 : !1;
                    for (j = 0; j < m; j++) for (g = 0; g < q; g++) ((a[f + g][n + j] = { cell: e, unique: k }), (a[f + g].nTr = d));
                }
                e = e.nextSibling;
            }
        }
	...
	d[c].push(b.value)
        ...
        a.oAjaxData = b;
        t(a, null, "preXhr", [a, b]);
        a.fnServerData ? a.fnServerData.call(
                j,
                a.sAjaxSource,
                ...
                i,
                a,
            ) : a.sAjaxSource || "string" === typeof g ? (a.jqXHR = h.ajax(h.extend(n, { url: g || a.sAjaxSource }))) : "function" === typeof g ? (a.jqXHR = g.call(j, b, i, a)) : ((a.jqXHR = h.ajax(h.extend(n, g))), (g.data = f));
    }
    function nb (a) {
    ...
    function wb (a) {
        ...
        for (g = 0; g < c; g++) ((n = b[g]), (m = f[g]), (i = "function" == typeof n.mData ? "function" : n.mData), G.columns.push({ data: i, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: m.sSearch, regex: m.bRegex } }), s("mDataProp_" + g, i), d.bFilter && (s("sSearch_" + g, m.sSearch), s("bRegex_" + g, m.bRegex), s("bSearchable_" + g, n.bSearchable)), d.bSort && s("bSortable_" + g, n.bSortable));
        ...
        b = l.ext.legacy.ajax;
        return (
            null === b ? a.sAjaxSource ? j : G : b ? j : G
        );
    }
    function xb (a, b) {
        var c = ua(a, b),
    ...
    function qb (a) {
        for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = Array.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", { name: c + "_length", "aria-controls": c, class: b.sLengthSelect }), g = 0, j = f.length; g < j; g++) e[0][g] = new Option("number" === typeof d[g] ? a.fnFormatNumber(d[g]) : d[g], f[g]);
    ...
    function Ha (a) {
        ...
        if (d || (!s && !f && !e && j == W(a) && j == n.length)) for (l = 0; l < j; l++) ((i = ba(a, l)), null !== i && (c[i].sWidth = w(n.eq(l).width())));
        else {
            ...
            for (l = 0; l < i.length; l++) ((o = c[i[l]]), (n[l].style.width = null !== o.sWidthOrig && "" !== o.sWidthOrig ? w(o.sWidthOrig) : ""), o.sWidthOrig && f && h(n[l]).append(h("<div/>").css({ width: o.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 })));
    ...
    function w (a) {
        return (
            null === a ? "0px" : "number" == typeof a ? 0 > a ? "0px" : a + "px" : a.match(/\d$/) ? a + "px" : a
        );
    }
    function Y (a) {
        var b,
    ...
    function Ya (a, b, c) {
        var d, e;
        for (e in b) b.hasOwnProperty(e) && ((d = b[e]), h.isPlainObject(d) ? (
    ...
    function Pa (a, b) {
        var c = a.renderer,
            d = l.ext.renderer[b];
        return (
            h.isPlainObject(c) && c[b] ? d[c[b]] || d._ : "string" === typeof c ? d[c] || d._ : d._
        );
    }
    function y (a) {
        return (
            a.oFeatures.bServerSide ? "ssp" : a.ajax || a.sAjaxSource ? "ajax" : "dom"
        );
    }
    function ja (a, b) {
        var c = [],
	...
	c.push("ellipsis"),
	c.push(b - 1)
) : (a >= b - 1 - d ? (c = Z(b - (c - 2), b)) : ((c = Z(a - d + 2, a + d - 1)), c.push("ellipsis"), c.push(b - 1)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0));
        c.DT_el = "span";
        return c;
    }
    function Fa (a) {
	...
	Lb(p, g, e)
        ...
        Rb = function (a, b, c) {
            return (
                M(a) ? !0 : !(M(a) || "string" === typeof a) ? null : ab(a.replace(Ca, ""), b, c) ? !0 : null
            );
        },
        C = function (a, b, c) {
            var d = [],
    ...
    r.registerPlural = u = function (a, b, c) {
        ...
        r.register(b, function () {
            ...
            return (
                a === this ? this : a instanceof r ? a.length ? Array.isArray(a[0]) ? new r(a.context, a[0]) : a[0] : k : a
            );
        });
    };
    var Vb = function (a, b) {
    ...
    o("page.len()", function (a) {
        return (
            a === k ? this.context.length !== 0 ? this.context[0]._iDisplayLength : k : this.iterator("table", function (b) {
                    Ta(b, a);
                })
        );
    });
    ...
    o("ajax.url()", function (a) {
        ...
        if (a === k) {
            ...
            b = b[0];
            return (
                b.ajax ? h.isPlainObject(b.ajax) ? b.ajax.url : b.ajax : b.sAjaxSource
            );
        }
        return this.iterator("table", function (b) {
    ...
    o("row().child()", function (a, b) {
        ...
        if (a === true) this.child.show();
            ...
            var d = c[0],
                ...
                e = [],
                f = function (a, b) {
                    if (Array.isArray(a) || a instanceof h) for (var c = 0, k = a.length; c < k; c++) f(a[c], b);
    ...
    o("search()", function (a, b, c, d) {
        var e = this.context;
        return (
            a === k ? e.length !== 0 ? e[0].oPreviousSearch.sSearch : k : this.iterator("table", function (e) {
                    e.oFeatures.bFilter && ha(e, h.extend({}, e.oPreviousSearch, { sSearch: a + "", bRegex: b === null ? false : b, bSmart: c === null ? true : c, bCaseInsensitive: d === null ? true : d }), 1);
                })
        );
    });
    ...
    l.models.oSettings = {
        ...
        fnDisplayEnd: function () {
            var a = this._iDisplayLength,
                ...
                f = e.bPaginate;
            return (
                e.bServerSide ? f === false || a === -1 ? b + d : Math.min(b + a, this._iRecordsDisplay) : !f || c > d || a === -1 ? d : c
            );
        },
        oInstance: null,
        sInstance: null,
    ...
    l.ext = v = { buttons: {}, classes: {}, builder: "-source-", errMode: "alert", feature: [], search: [], selector: { cell: [], column: [], row: [] }, internal: {}, legacy: { ajax: null }, pager: {}, renderer: { pageButton: {}, header: {} }, order: {}, type: { detect: [], search: {}, order: {} }, _unique: 0, fnVersionCheck: l.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: l.version };
                    ...
                    s = function (b, d) {
                        ...
                        for (u = d.length; k < u; k++) {
                            ...
                            if (Array.isArray(r)) {
                                ...
                                if (l !== null) {
                                    t = h("<a>", { class: g.sPageButton + " " + m, "aria-controls": a.sTableId, "aria-label": i[r], "data-dt-idx": o, tabindex: t, id: c === 0 && typeof r === "string" ? a.sTableId + "_" + r : null })
                                        .html(l)
                                        .appendTo(b);
                                    Xa(t, { action: r }, w);
                                    o++;
    ...
    h.extend(l.ext.type.search, {
        html: function (a) {
            return (
                M(a) ? a : typeof a === "string" ? a.replace(Ob, " ").replace(Ca, "") : ""
            );
        },
        string: function (a) {
            return (
                M(a) ? a : typeof a === "string" ? a.replace(Ob, " ") : a
            );
        },
    });
    ...
    h.extend(v.type.order, {
        ...
        "html-pre": function (a) {
            return (
                M(a) ? "" : a.replace ? a.replace(/<.*?>/g, "").toLowerCase() : a + ""
            );
        },
        "string-pre": function (a) {
            return (
                M(a) ? "" : typeof a === "string" ? a.toLowerCase() : !a.toString ? "" : a.toString()
            );
        },
