        ...
        <div class="collapse navbar-collapse" id="navMain">
            ...
            <div class="d-flex gap-2 align-items-center mt-2 mt-lg-0">
                <?php if ($isLoggedIn): ?>
                    ...
                    <button class="btn btn-outline-danger rounded-pill px-3" onclick="location.href='logout.php'">Log Out</button>
                <?php else: ?>
                    <button class="btn btn-outline-secondary rounded-pill px-3" onclick="location.href='login.php'">Sign In</button>
                    <button class="btn btn-primary rounded-pill px-3" onclick="location.href='signup.php'">Sign Up</button>
                <?php endif; ?>
