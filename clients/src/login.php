<?php
session_start();
// login.php - Professional Version
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="auth-card">
    <div class="auth-header">
        ...
        <p class="mb-0 opacity-75">Sign in to start shopping</p>
    </div>
    <div class="auth-body">
        ...
        <form id="loginForm">
            ...
            <div class="text-center small text-muted">
                Don't have an account? <a href="signup.php" class="text-decoration-none fw-bold text-primary">Sign Up</a>
            </div>
        </form>
    </div>
</div>

<!-- Hidden form to process session in PHP after JS login success -->
<form id="sessionForm" action="processLogin.php" method="POST" style="display:none;">
    <input type="hidden" name="user_data" id="userDataInput">
</form>
...
document.getElementById('loginForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        if (result.success) {
            // Send user data to processLogin.php to set the session
            document.getElementById('userDataInput').value = JSON.stringify(result.data);
